...
TRAIN_CONFIG="$SCRIPT_DIR/configs/entityRecognizer/hf_train.yaml"
INFER_CONFIG="$SCRIPT_DIR/configs/entityRecognizer/hf_inference.yaml"

LOG_DIR="$SCRIPT_DIR/logs/entityRecognizer/batch_hf"
...
What it does:
  ...
  - For each model:
      1. trains the entity recognizer
      2. runs inference with the trained checkpoint

Expected layout:
  - scripts/run_entity_recognizer.sh
  - scripts/configs/entityRecognizer/hf_train.yaml
...
log "=================================================="
log "Batch HF entity recognizer run started"
...
log ""
log "=================================================="
log "All HF entity recognizer experiments completed successfully."
