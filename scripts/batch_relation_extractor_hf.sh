...
TRAIN_CONFIG="$SCRIPT_DIR/configs/relationExtractor/hf_train.yaml"
INFER_CONFIG="$SCRIPT_DIR/configs/relationExtractor/hf_inference.yaml"

LOG_DIR="$SCRIPT_DIR/logs/relationExtractor/batch_hf"
...
log "=================================================="
log "Batch HF relation extractor run started"
...
for MODEL_NAME in "${MODELS[@]}"; do
    ...
    CHECKPOINT_PATH="checkpoints/relationExtractor/$OUTPUT"
    PREDICTIONS_PATH="runs/relationExtractor/${OUTPUT}_inference_predictions.json"
...
log ""
log "=================================================="
log "All HF relation extractor experiments completed successfully."
