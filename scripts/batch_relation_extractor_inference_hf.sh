...
INFER_CONFIG="$SCRIPT_DIR/configs/relationExtractor/hf_inference.yaml"

LOG_DIR="$SCRIPT_DIR/logs/relationExtractor/batch_inference_hf"
...
usage() {
    cat <<USAGE
Usage:
  bash scripts/batch_relation_extractor_inference_hf.sh
...
Expected layout:
  ...
  - scripts/configs/relationExtractor/hf_inference.yaml
  - run_relation_extractor.py in the project root
  - Pre-trained checkpoints in checkpoints/relationExtractor/
...
Derived output paths:
  predictions: runs/relationExtractor/<derived_model_name>_dev_predictions.json
USAGE
}
...
# ============================================================
CHECKPOINTS=(
    "checkpoints/relationExtractor/BioLinkBERT-base"
    "checkpoints/relationExtractor/BioLinkBERT-large"
    "checkpoints/relationExtractor/BiomedNLP-BiomedBERT-base-uncased-abstract"
    "checkpoints/relationExtractor/BiomedNLP-BiomedBERT-base-uncased-abstract-fulltext"
    "checkpoints/relationExtractor/BiomedNLP-BiomedBERT-large-uncased-abstract"
    "checkpoints/relationExtractor/BiomedNLP-BiomedElectra-base-uncased-abstract"
    "checkpoints/relationExtractor/BiomedNLP-BiomedElectra-large-uncased-abstract"
)
...
log "=================================================="
log "Batch HF relation extractor inference run started"
...
for CHECKPOINT_PATH in "${CHECKPOINTS[@]}"; do
    ...
    PREDICTIONS_PATH="runs/relationExtractor/${OUTPUT}_dev_predictions.json"
...
log ""
log "=================================================="
log "All HF relation extractor inference experiments completed successfully."
